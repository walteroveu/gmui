...
<template>
  <div class="side-nav">
    <div v-for="title in (Object.keys(data))" class="group-container" :key="title.id">
      <p class="side-nav-title">{{title}}</p>
      <div class="side-nav-items" v-for="nav in data[title]" v-bind:key="nav.id" v-if="nav.desc" >
        ...
        <div v-for="item in nav.items" v-bind:key="item.id">
